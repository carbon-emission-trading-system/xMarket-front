    ...
    <el-card class="list1" >
      <table class="mailTable" :style="styleObject" >
        ...
        <tr>
          ...
          <td>{{this.realTimeData.sellOneToFive[4].price}}</td>
          <td>{{this.realTimeData.sellOneToFive[4].quantity}}</td>
        </tr>
        <tr>
          <td class="column">卖四</td>
          <td>{{this.realTimeData.sellOneToFive[3].price}}</td>
          <td>{{this.realTimeData.sellOneToFive[3].quantity}}</td>
        </tr>
        <tr>
          <td class="column">卖三</td>
          <td>{{this.realTimeData.sellOneToFive[2].price}}</td>
          <td>{{this.realTimeData.sellOneToFive[2].quantity}}</td>
        </tr>
        <tr>
          <td class="column">卖二</td>
          <td>{{this.realTimeData.sellOneToFive[1].price}}</td>
          <td>{{this.realTimeData.sellOneToFive[1].quantity}}</td>
        </tr>
        <tr>
          <td class="column">卖一</td>
          <td>{{this.realTimeData.sellOneToFive[0].price}}</td>
          <td>{{this.realTimeData.sellOneToFive[0].quantity}}</td>
        </tr>
      </table>
      ...
      <table class="mailTable" :style="styleObject">
        ...
        <tr>
          ...
          <td>{{this.realTimeData.buyOneToFive[0].price}}</td>
          <td>{{this.realTimeData.buyOneToFive[0].quantity}}</td>
        </tr>
        <tr>
          <td class="column">买二</td>
          <td>{{this.realTimeData.buyOneToFive[1].price}}</td>
          <td>{{this.realTimeData.buyOneToFive[1].quantity}}</td>
        </tr>
        <tr>
          <td class="column">买三</td>
          <td>{{this.realTimeData.buyOneToFive[2].price}}</td>
          <td>{{this.realTimeData.buyOneToFive[2].quantity}}</td>
        </tr>
        <tr>
          <td class="column">买四</td>
          <td>{{this.realTimeData.buyOneToFive[3].price}}</td>
          <td>{{this.realTimeData.buyOneToFive[3].quantity}}</td>
        </tr>
        <tr>
          <td class="column">买五</td>
          <td>{{this.realTimeData.buyOneToFive[4].price}}</td>
          <td>{{this.realTimeData.buyOneToFive[4].quantity}}</td>
        </tr>
      </table>
